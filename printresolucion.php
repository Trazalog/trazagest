...
<head>
 ...
 ';
$idresu = $_GET["id"];
$consulta = "Select * From expedientespdf Where id_resolu=".$idresu;
          ...
          <table width="100%" style="text-align:justify">
            ...
            <tr>
              <td height="4" colspan="4" class="text-right" align="right"> 
                <!--<hr />
                <h3><center>RESOLUCIÓN</center></h3>
                <hr />-->
              </td>
              <tr align="right">
                <td width="50%" height="23"> <td/>
                <td  colspan="4"  align="right"> <b> San Juan : '.fecha_larga($respueta['fecha'],1).'</b>
                </td>
	          </tr> 
              <tr>
	          ...
	          <tr>
	            <td height="41" colspan="4" ><br /><!-- Detalle de Oficio -->';  
                $html.= '<p  style="font-size:medium "align="justify" >'.$respueta['observacion'].'</p>    
                </td>
              </tr>
              <tr>
              <td height="4" colspan="4" >
