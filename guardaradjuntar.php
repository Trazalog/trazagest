...
//$uploaddir = $this->utilidades->get_url_adjuntos();
            $uploaddir = $_SERVER['DOCUMENT_ROOT']."/trazagest/fileexp/";
            //print_r($uploaddir);
           ...
           // $nfo=0;
            ...
            {   //$nfo=$nfo+1; 
                ...
                if (in_array($ext, $extperm))  //comprubo que sea una extension permitida
                {
                    ...
                    $consu=" INSERT INTO adjunto_expediente(id_mov,fecha,usuario,file) VALUES ('$idmovi','$fecha','','')";
               ...
               //ultimoId=$this->db->insert_id(); //traigo el ultimo id
                ...
                //print_r($ultimoid);
                    ...
                    $nombre=$ultimoid."_".date('Y-m-d')."_".$idmovi.".".$ext;
                    ...
                    if($ecxedesize==0)
                    {
                        ...
                        //if(0)
                        {
                            ...
                            $consu3="UPDATE adjunto_expediente SET file='$nombre' WHERE id_adjunto='$ultimoid' ";
