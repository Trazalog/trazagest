					 ...
					 if(mysql_num_rows($resu2)== 0)
					 	{
							...
							$consulta3 = "Select $campos from ".$nombreTabla." as t Limit 0,".$tamañoPagina;
							//echo"$consulta3";
								 ...
								 echo '<tr><td colspan="10"></td></tr>';
								}else
									{
										while($row_1 = mysql_fetch_array($resu3))
											...
											//editar 
											echo "<td onclick=\"AbrirPop('".$nombreTabla."','U','$row_1[0]','".$TamañoPopUp."')\" style=\"text-align: center;\" title=\"Editar\" ><img src=\"./assest/plugins/buttons/icons/pencil.png\" width='15' heigth='15' /></td>";
											//--
											
											//eliminar
											echo "<td onclick=\"AbrirPop('".$nombreTabla."','D','$row_1[0]','".$TamañoPopUp."')\" style=\"text-align: center;\" title=\"Eliminar\" ><img src=\"./assest/plugins/buttons/icons/cancel.png\"   width='15' heigth='15' /></td>";
											//--
											 echo '</tr>';
											}
									}
...
function AbrirVentana(tabla,accion,id,tamaño)
	{
	 /*
