...
//$orden="ORDER BY  nro_expediente  DESC";	
$sqlgral.= $filtro ;
...
echo "<table  id=personas border=\"1\" width=\"100%\">";
      ...
      print "<br>" ;
	   ...
	   //print "<th class='cont1'>Fechas Hasta</th>";
      ...
      while ($registro = mysql_fetch_row($result))
      {
					...
					case "E":
					   echo "<td class='cont6' align=\"center\">$registro[4]</td>";
						break;
					case "R":
					   echo "<td class='cont7' align=\"center\">$registro[3]</td>";
						break;
...
echo "<table width=\"80%\" align=\"center\" class=\"borde_tabla\"><tr><td class=\"tituloformulario\" align=\"center\">Filtro de Expedientes</td></tr></table>";
listarnuevo($resgral,0);

echo "    ";
echo "<br>";
echo"<input type=\"button\"  class=\"btn btn-primary\" name=\"filtra\" id=\"filtrar\" value=\"Volver\" onclick=\"window.history.back();\" 
class=\"boton\" />";
echo"</form>";	
